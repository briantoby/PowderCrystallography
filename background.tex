...
where $B$ is the background, $Q = 4\pi/d$ and there are $i$ sets of  adjustable terms $A_i$, $R_i$ and $U_i$, which can be individually selected for refinement, as desired. 
...
\section{Approaches to Fitting Background}\label{ref:backgroundfit}
...
\section{Negative \texorpdfstring{$\rm U_{iso}$}{Uiso} values}\label{ref:negativeUiso}
