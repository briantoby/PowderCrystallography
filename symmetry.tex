...
The term atomic displacement parameter\index{atomic displacement parameter}\index{ADP|textbf}, which describes both static and dynamic disorder of that atom from its average position is an important concept that is commonly abbreviated as ADP, particularly for single-crystal structure determination. 
