...
\DeclareUnicodeCharacter{2061}{ }  % removes an extraneous (normally invisible) Unicode character
...
% TeX4ht: suppress ligatures globally in HTML output so sequences like "ff"
% are emitted reliably in headings and body text.
\AtBeginDocument{%
  \DisableLigatures{encoding = *, family = *}%
  \Css{body, h1, h2, h3, h4, h5, h6, p, li, td, th, figcaption {font-variant-ligatures:none; font-feature-settings:"liga" 0, "clig" 0;}}%
}
...
% Title
\textbf{\fontsize{30}{54}\selectfont \bookname\\}
