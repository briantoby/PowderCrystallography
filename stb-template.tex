...
\begin{document}
\ifCover
    % 1. Insert Front Cover
    % pagecommand={} ensures standard header/footers are suppressed on the cover
    \includepdf[pages=1]{figures/FrontCoverPreview.pdf} 
\else
...
\printindex
\ifKindle
    \input{AboutTheCover} % add this only for the print copy
%\else
%    Use this text for electronic PDF
\fi

\ifCover
    % Insert About Cover & rear cover
    \input{AboutTheCover} % add this only for the print copy
    \includepdf[pages=1]{figures/RearCoverPreview.pdf} 
\fi
