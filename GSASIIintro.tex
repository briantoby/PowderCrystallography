...
\textbf{Reduced $\chi^2$}\index{reduced $\chi^2$}\label{ref:redchi2}: This is computed from 
...
\textbf{Goodness of Fit, GOF}\index{goodness of fit}\index{GOF}\label{ref:GOF}: This is commonly used in single-crystal fitting. 
