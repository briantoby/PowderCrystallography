...
As was explored in \S\ref{ref:rho}, if we know the structure factors, including their phases, we can use the Fourier inversion of the structure factor equation,
...
\subsection{Viewing a Fourier map}\label{ref:FourierViewOpts}
...
\subsection{Are map peaks artifacts?}
...
\section{Le Bail Fitting}\label{ref:LeBail}\index{Le Bail fitting|textbf}
...
\begin{quote}
There is a short chapter on Fourier techniques and some discussion of Pawley and Le Bail extraction here.
\end{quote}
...
\begin{quote}
There is some discussion of Fourier techniques here.
\end{quote}

\item 
\textit{The Fast Fourier Transform} (1974), E. O. Brigham, Prentice-Hall. 
\begin{quote}
As a graduate student, I found this book very helpful for understanding Fourier transforms. The next two URLs may be even more valuable.
\end{quote}

\item
The Crystallographic Resources at Otterbein University website provides an online Fourier transform computation that I think is quite educational, 
\url{https://djohnston66.gitlab.io/fft/}

\item
Kathryn Cowtan\index{Cowtan, K.} has a ``Picture Book of Fourier Transforms'' website that has some very educational illustrations, \url{http://www.ysbl.york.ac.uk/~cowtan/fourier/fourier.html}
\end{itemize}
