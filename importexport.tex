...
\subsubsection{Instrument Parameter Files}\index{instrument parameter file|textbf}
...
\subparagraph{Write an instrument parameter file}\index{create!instrument parameter file}
...
\subsubsection{Generating a GSAS-II powder diffraction file}\index{create!GSAS-II powder data file}
